//## begin module%41947173022E.cm preserve=no
//	  %X% %Q% %Z% %W%
//## end module%41947173022E.cm

//## begin module%41947173022E.cp preserve=no
//## end module%41947173022E.cp

//## Module: CDiffusionVarCo%41947173022E; Package body
//## Subsystem: <Top Level>
//## Source file: C:\zbf\Research\3dViewer\CDiffusionVarCo.cpp

//## begin module%41947173022E.additionalIncludes preserve=no
#include "stdafx.h"
//## end module%41947173022E.additionalIncludes

//## begin module%41947173022E.includes preserve=yes
//## end module%41947173022E.includes

// CDiffusionVarCo
#include "CDiffusionVarCo.h"
//## begin module%41947173022E.declarations preserve=no
//## end module%41947173022E.declarations

//## begin module%41947173022E.additionalDeclarations preserve=yes
//## end module%41947173022E.additionalDeclarations
...
CDiffusionVarCo::CDiffusionVarCo ()
  //## begin CDiffusionVarCo::CDiffusionVarCo%41947085030F.hasinit preserve=no
  //## end CDiffusionVarCo::CDiffusionVarCo%41947085030F.hasinit
  //## begin CDiffusionVarCo::CDiffusionVarCo%41947085030F.initialization preserve=yes
  //## end CDiffusionVarCo::CDiffusionVarCo%41947085030F.initialization
{
  //## begin CDiffusionVarCo::CDiffusionVarCo%41947085030F.body preserve=yes
//CDiffusionVarCo::CDiffusionVarCo ()
{  
	InitPara();
...
*/
  ...
  //## end CDiffusionVarCo::CDiffusionVarCo%41947085030F.body
}


CDiffusionVarCo::~CDiffusionVarCo ()
{
  //## begin CDiffusionVarCo::~CDiffusionVarCo%41947085030E.body preserve=yes

//CDiffusionVarCo::~CDiffusionVarCo ()
{  
}

  //## end CDiffusionVarCo::~CDiffusionVarCo%41947085030E.body
}
...
{
  //## begin CDiffusionVarCo::ChangeCoefficient%4194708502FB.body preserve=yes
...
//int CDiffusionVarCo::ChangeCoefficient (int nLevel)
{
  ...
  //## end CDiffusionVarCo::ChangeCoefficient%4194708502FB.body
}

int CDiffusionVarCo::CalcNewThreshold (int nDensity)
{
  //## begin CDiffusionVarCo::CalcNewThreshold%4194708502FD.body preserve=yes
...
//int CDiffusionVarCo::CalcNewThreshold(int nDensity)
{
  ...
  //## end CDiffusionVarCo::CalcNewThreshold%4194708502FD.body
}

void CDiffusionVarCo::InitPara ()
{
  //## begin CDiffusionVarCo::InitPara%4194708502FF.body preserve=yes
...
m_lpRandomScale[127]= 100;
  ...
  //## end CDiffusionVarCo::InitPara%4194708502FF.body
}

int CDiffusionVarCo::offset1 (int x, int y, int w, int h)
{
  //## begin CDiffusionVarCo::offset1%419470850300.body preserve=yes
...
//int CDiffusionVarCo::offset1( int x, int y, int w, int h)
{
 return (((x)<(w)&&(y)<(h)) ? ((y)*(w)+((w)-(x)-1)) : 0);
  ...
  //## end CDiffusionVarCo::offset1%419470850300.body
}

int CDiffusionVarCo::offset (int x, int y, int w, int h)
{
  //## begin CDiffusionVarCo::offset%419470850305.body preserve=yes

//		int CDiffusionVarCo::offset( int x, int y, int w, int h)
{
 return (((x)<(w)&&(y)<(h)) ? ((y)*(w)+(x)) : 0);
}
  //## end CDiffusionVarCo::offset%419470850305.body
}

int CDiffusionVarCo::ImageDiffusion (int* lpImg, int nImgWidth, int nImgHeight)
{
  //## begin CDiffusionVarCo::ImageDiffusion%41947085030A.body preserve=yes
...
//将由舍入误差引起的误差记入下面的象素
  ...
  //## end CDiffusionVarCo::ImageDiffusion%41947085030A.body
}

int CDiffusionVarCo::ImageDiffusion (LPBYTE lpImg, int nImgWidth, int nImgHeight)
{
  //## begin CDiffusionVarCo::ImageDiffusion%419478110180.body preserve=yes
	int *lpImg1;
	int w,h;

	w = nImgWidth;
	h = nImgHeight;
	lpImg1 = (int*)malloc(w*h*sizeof(int));
	for ( int i = 0; i < w*h; i++)
  ...
  //## end CDiffusionVarCo::ImageDiffusion%419478110180.body
}

int CDiffusionVarCo::ImageDiffusion (double* lpImg, int nImgWidth, int nImgHeight)
{
  //## begin CDiffusionVarCo::ImageDiffusion%419735C401AC.body preserve=yes
	...
	int nSum = m_nSum;
//	int iError, iPixel, iError1;
	double iError, iPixel, iError1;
	int j;
	int i;

//	_int16 *lpImg0 = (_int16*)malloc(nImgWidth*nImgHeight*sizeof(_int16));
	double *lpImg0 = (double*)malloc(nImgWidth*nImgHeight*sizeof(double));
	...
	for ( j = 0; j < nImgHeight; j++ )
		...
		if ( (j%2) == 0 )
		{
			nImgIndex	= offset(i,j,nImgWidth,nImgHeight);
//			iPixel		= lpImg[nImgIndex];
			iPixel		= lpImg[nImgIndex];//Note: input image is 255.0-based, not 1.0-based.
			nSum		= this->ChangeCoefficient(int(double(lpImg0[nImgIndex])+0.5));

			if ( iPixel > (double)CalcNewThreshold(int(double(lpImg0[nImgIndex])+0.5)))
			{
				lpImg[nImgIndex]	= 255;
				iError				= iPixel - 255;
			}
...
//将由舍入误差引起的误差记入下面的象素
		...
		{//(j%2) ！= 0
			...
			if ( iPixel > CalcNewThreshold(int(lpImg0[nImgIndex]))+0.5 )
			{
				lpImg[nImgIndex]	= 255;
				iError				= iPixel - 255;
			}
  ...
  //## end CDiffusionVarCo::ImageDiffusion%419735C401AC.body
}

// Additional Declarations
  //## begin CDiffusionVarCo%41947085029E.declarations preserve=yes
  //## end CDiffusionVarCo%41947085029E.declarations

//## begin module%41947173022E.epilog preserve=yes
//## end module%41947173022E.epilog
